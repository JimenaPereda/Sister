...
<Col>
  <Form.Control className="emergenvyContInfo" type="text" placeholder="Emergency contact Name" />
</Col>
<Form.Label column lg={2}>
 Emergency contact Phone number:
</Form.Label>
<Col>
  <Form.Control className="emergenvyContInfo" type="text" placeholder="Emergency contact Phone number" />
</Col>
<Form.Label column lg={2}>
 Emergency contact Email:
</Form.Label>
<Col>
  <Form.Control className="emergenvyContInfo"  type="text" placeholder="Emergency contact Email" />
</Col>
<Form.Label column lg={2}>
 Emergency contact City of Recidence:
</Form.Label>
<Col>
  <Form.Control className="emergenvyContInfo"  type="text" placeholder="Emergency contact City of Recidence" />
</Col>
</Form.Row>
